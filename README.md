...
* **Experiment 01 – Basic Logic Circuits** 
  Implementation of fundamental logic gates and combinational circuits [View Experiment](./Experiment_01)

* **Experiment 02 – 4-bit Ripple Carry Adder** 
  Design and simulation of a 4-bit adder using basic building blocks [View Experiment](./Experiment_02)

* **Experiment 03 – GDB Debugger (Compiler Debugging)** 
  Debugging C programs using GNU Debugger (GDB) [View Experiment](./Experiment_03)

* **Experiment 04 – 8-bit Shift Register using Flip-Flops** 
  Design a 8-bit Shift Register using D Flip Flops [View Experiment](./Experiment_04)

* **Experiment 05 – Addressing Modes** 
  Executing different kinds of Addressing modes using gdb compiler [View Experiment](./Experiment_05)

* **Experiment 06 – Shift Registers** 
  Executing different kinds of Shift registers using logisim simulator [View Experiment](./Experiment_06)
